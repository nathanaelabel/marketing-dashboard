<div class="mt-10 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg shadow">
                <h3 class="text-sm font-medium text-gray-500" id="store-returns-label" x-text="$store.lang.current === 'id' ? 'Retur Toko' : 'Store Returns'"></h3>
                <p class="mt-1 text-2xl font-semibold text-gray-900" id="store-returns-value">-</p>
            </div>
            <div class="bg-gray-50 p-4 rounded-lg shadow">
                <h3 class="text-sm font-medium text-gray-500" id="stock-value-label" x-text="$store.lang.current === 'id' ? 'Nilai Stok' : 'Stock Value'"></h3>
        ...
        <div class="lg:col-span-2 bg-gray-50 p-4 rounded-lg shadow">
            <h3 class="text-lg font-medium text-gray-500" x-text="$store.lang.current === 'id' ? 'Piutang Jatuh Tempo' : 'Accounts Receivable'"></h3>
