document.addEventListener("DOMContentLoaded", function () {
    ...
    const arCurrentDatePicker = flatpickr("#ar_current_date", {
        ...
        altInput: true,
        defaultDate:
            document.getElementById("ar_current_date").value || new Date(),
        maxDate: "today",
        onChange: function (selectedDates, dateStr, instance) {
            ...
            document.dispatchEvent(
                new CustomEvent("ar-date-changed", {
                    detail: { date: dateStr },
                })
            );
        },
        ...
        fetch(url)
            ...
            .then((data) => {
                ...
                if (currentDateInput) {
                    ...
                    if (
                        altInput &&
                        altInput.classList.contains("flatpickr-input")
                    ) {
                ...
                // Determine scale based on filter and max value (excluding ANOMALY and Connection Failed datasets)
                let maxValue = 0;
                ...
                // Calculate total stacked values per bar (excluding ANOMALY and Connection Failed datasets)
                        ...
                        plugins: {
                            legend: {
                                ...
                                labels: {
                                    ...
                                    filter: function (legendItem, chartData) {
                                        // Hide ANOMALY and Connection Failed from legend
                                        return (
                            ...
                            tooltip: {
                                ...
                                callbacks: {
                                    label: function (context) {
                                        // Skip ANOMALY and Connection Failed datasets in tooltip
                                        if (
                                    ...
                                    footer: function (tooltipItems) {
                                        // Calculate total from aging range datasets only (exclude ANOMALY and Connection Failed)
                                        let total = 0;
                            ...
                            datalabels: {
                                display: function (context) {
                                    // For ANOMALY and Connection Failed datasets, use their own config
                                    if (
                                ...
                                formatter: function (value, context) {
                                    // For ANOMALY bars, show 'ANOMALY' label
            ...
            .catch((error) => {
                console.error(
                    "Error fetching Accounts Receivable data:",
                    error
                );
    ...
    if (exportBtn) {
        exportBtn.addEventListener("click", function (e) {
            ...
            const currentDate =
                document.getElementById("ar_current_date").value;
