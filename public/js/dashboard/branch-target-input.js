document.addEventListener("DOMContentLoaded", function () {
    ...
    function showFieldError(fieldName, message) {
        const input = document.querySelector(
            `input[name="targets[${fieldName}]"]`
        );
        const errorElement = document.getElementById(
            `error_${fieldName.replace(" ", "_")}`
        );
    ...
    form.addEventListener("submit", function (e) {
        ...
        fetch("/branch-target/save", {
            ...
            .catch((error) => {
                ...
                setLoading(false);
                showAlert(
                    "An error occurred while saving targets. Please try again."
                );
            });
    });
    ...
    function performDelete() {
        ...
        fetch("/branch-target/delete", {
            ...
            .catch((error) => {
                ...
                hideDeleteModal();
                showAlert(
                    "An error occurred while deleting targets. Please try again."
                );
            });
    }
